            ...
            if not serializer.validated_data.get('Exclusionary_Criteria'):
                ...
                if query.count() > 0:
                    if serializer.validated_data.get('gender') == 1:
                        ...
                        serializer.save(facility_type=facility_preds,level_of_care=level_pred,
                        ...
                        if serializer.validated_data.get('inclusionary_criteria') == True:
                            # logger.info(
                            #     'where Exclusionary_Criteria-False, gender-2,inclusionary_criteria=true,condition_program-2')
                            condition_program = 2
